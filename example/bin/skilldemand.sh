...
OUTPUT_FILE=skilldemand.out

java -cp ${CP} org.rivalry.example.skilldemand.SkillDemandDataCollectorMain &> ${OUTPUT_FILE}
...
if [ ${LINE_COUNT} -eq 102 ];
then
	cp -f SkillDemandRivalryData.xml ${USER_DIR}/Dropbox/Public/rivalry 
fi
